...
Bin/simulation: Bin/main.o Bin/interaction.o Bin/potentiel.o Bin/XYZ.o Bin/remplissage_vecteurs.o Bin/constantes.o Bin/voisinlist3.o
...
Bin/voisinlist3.o: Sources/voisinlist3.cpp Headers/interaction.h Headers/types.h Headers/constantes.h SoA/particule.h
	$(CC) $(CFLAGS) $(OFLAGS) -c -o $@ $<
